...
\begin{document}
	...
	\include{choix_extensions_ch00_front}
	\pagenumbering{arabic}
	\include{choix_extensions_ch01_priseEnMain}
	\include{choix_extensions_ch02_compilation}
	\include{choix_extensions_ch03_pages}
	\include{choix_extensions_ch04_par_speciaux}
	\include{choix_extensions_ch05_listes}
	\include{choix_extensions_ch06_graphiques}
	\include{choix_extensions_ch07_tableaux}
	\include{choix_extensions_ch08_maths}
	\include{choix_extensions_ch09_informatique}
	\include{choix_extensions_ch10_bibliographies}
\end{document}
